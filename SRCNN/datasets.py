    ...
    def __init__(self, root, hr_shape, scale, mean, std):
        ...
        self.lr_transform = transforms.Compose(
            [
                ...
                # Low-resolution images are scaled to the target image size before input to the model
                transforms.Resize((hr_height // scale * scale, hr_height // scale * scale), Image.BICUBIC),
                transforms.ToTensor(),
