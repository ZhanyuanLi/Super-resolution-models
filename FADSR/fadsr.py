...
def main():
    ...
    parser.add_argument("--hr_height", type=int, default=100, help="image height")
    parser.add_argument("--hr_width", type=int, default=100, help="image width")
    parser.add_argument("--scale", type=int, default=5, help="Image magnification")
    parser.add_argument("--summary_writer_name", type=str, default="FADSR_Loss_PSNR_SSIM",
                        help="name of the summary writer file")
    parser.add_argument("--channels", type=int, default=3, help="number of image channels")
    parser.add_argument("--sample_interval", type=int, default=100, help="interval between saving image samples")
    parser.add_argument("--checkpoint_interval", type=int, default=10, help="interval between model checkpoints")  # -1
    # Obtain parameters
    ...
    for epoch in range(opt.epoch, opt.n_epochs):
        ...
        # F:\FADSR>tensorboard --logdir ./FADSR_Loss_PSNR_SSIM --port=6006
